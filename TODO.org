...
* TODO Presenter module needs 2 videos
...
* TODO [#B] Songs should have a place to store the audio file and then play it during editing so you can ensure the order of verses
